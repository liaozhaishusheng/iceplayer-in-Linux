...
//g_print("链接管道获取信息1\n");
    ...
    gui_treeview_info_codec[0]=NULL;
    gui_treeview_info_start[0]=NULL;
    gui_treeview_info_duration[0]=NULL;
    gui_treeview_info_bitrate[0]=NULL;
    gui_treeview_info_uri[0]=NULL;
    gui_treeview_info_title[0]=NULL;
    gui_treeview_info_artist[0]=NULL;
    gui_treeview_info_album[0]=NULL;
    gui_treeview_info_genre[0]=NULL;
    track=NULL;
...
strcpy(a,b);
      ...
      strcpy(su,"/usr/share/iceplayer/id3 -tag -edit -quiet ");
