...
gboolean change_alpha(GtkWidget *hscale) {
    ...
    configure.window_alpha = gtk_range_get_value(hscale);
    iceplayer_image = cairo_image_surface_create_from_png_new(iceplayer_image,get_iceplayer_back_pic());
    if (configure.widget_lrc_show_type!=WIDGET_LRC_SHOW_TYPE_INTEGRATION && configure.widget_lrc_show_type!=  WIDGET_LRC_SHOW_TYPE_HPANED)iceplayer_widget_lrc_image = cairo_image_surface_create_from_png_new(iceplayer_widget_lrc_image,get_iceplayer_widget_lrc_back_pic());
...
gboolean update_configure() {
    ...
    if (GTK_IS_WIDGET(iceplayer.window)&&(windows_state==WINDOWS_STATE_SHOW||windows_state==WINDOWS_STATE_SHOW_ALL_WORK_PLACES)) {
        gtk_window_get_size(iceplayer.window,&configure.width,&configure.height);
        gtk_window_get_position(iceplayer.window,&configure.x,&configure.y);
    }
    if (GTK_IS_WIDGET(desktop_lrc.window)&&configure.desktop_lrc) {
        gtk_window_get_size(desktop_lrc.window,&configure.desktop_lrc_width,&configure.desktop_lrc_height);
        gtk_window_get_position(desktop_lrc.window,&configure.desktop_lrc_x,&configure.desktop_lrc_y);
    }
    configure.list_hpaned_pos = gtk_paned_get_position(iceplayer.list_hpaned);
    configure.hpaned_pos = gtk_paned_get_position(iceplayer.hpaned);

    configure.auto_update = gtk_toggle_button_get_active(configure_widget.auto_update_checkbutton);
    configure.task_bar= gtk_toggle_button_get_active(configure_widget.show_in_taskbar_checkbutton);
    configure.decorated = gtk_toggle_button_get_active(configure_widget.decorated);
    configure.tray = gtk_toggle_button_get_active(configure_widget.show_tray_checkbutton);
    configure.above = gtk_toggle_button_get_active(configure_widget.always_above_checkbutton);
    configure.all_work_places = gtk_toggle_button_get_active(configure_widget.show_in_all_work_places_checkbutton);
    configure.begin_min = gtk_toggle_button_get_active(configure_widget.open_and_min_checkbutton);
    configure.last_pos = gtk_toggle_button_get_active(configure_widget.last_pos_checkbutton);
    configure.begin_play = gtk_toggle_button_get_active(configure_widget.open_and_play_checkbutton);
    configure.notify = gtk_toggle_button_get_active(configure_widget.notify_checkbutton);
    configure.failed_stop = gtk_toggle_button_get_active(configure_widget.failed_and_stop_checkbutton);
    configure.auto_jump_to_play = gtk_toggle_button_get_active(configure_widget.auto_jump_to_playing_checkbutton);
    configure.lrc = gtk_toggle_button_get_active(configure_widget.use_lrc_checkbutton);
    gboolean selr = configure.search_lrc ;
    configure.search_lrc = gtk_toggle_button_get_active(configure_widget.use_search_lrc_checkbutton);
    if (selr!=configure.search_lrc&&configure.search_lrc==TRUE)
        lrc();
    strcpy(configure.search_lrc_time , gtk_entry_get_text(configure_widget.search_lrc_time_entry ));
    configure.search_filename_or_id3 = gtk_toggle_button_get_active(configure_widget.search_lrc_with_filename_and_id3_checkbutton);
    configure.edit_search_word = gtk_toggle_button_get_active(configure_widget.edit_search_lrc_checkbutton);
    configure.desktop_lrc = gtk_toggle_button_get_active(configure_widget.use_desktop_lrc_checkbutton);
    configure.desktop_lrc_lock = gtk_toggle_button_get_active(configure_widget.desktop_lrc_lock_checkbutton);
    configure.desktop_lrc_kalaok = gtk_toggle_button_get_active(configure_widget.desktop_lrc_use_kalaok_checkbutton);
    configure.desktop_lrc_above = gtk_toggle_button_get_active(configure_widget.desktop_lrc_above_checkbutton);
    configure.lists_use_system_theme = gtk_toggle_button_get_active(configure_widget.lists_use_system_theme_checkbutton);

    strcpy(configure.download_lrc_path,gtk_entry_get_text(configure_widget.lrc_download_path_entry ));
    strcpy(configure.search_lrc_path_1,gtk_entry_get_text(configure_widget.local_lrc_path_1_entry ));
    strcpy(configure.search_lrc_path_2,gtk_entry_get_text(configure_widget.local_lrc_path_2_entry ));
    strcpy(configure.search_lrc_path_3,gtk_entry_get_text(configure_widget.local_lrc_path_3_entry ));

    strcpy(configure.info_name_font,gtk_font_button_get_font_name(configure_widget.info_name_fontbutton));
    strcpy(configure.info_time_font,gtk_font_button_get_font_name(configure_widget.info_time_fontbutton));

    GdkColor color;
    strcpy(configure.widget_lrc_font,gtk_font_button_get_font_name(configure_widget.widget_lrc_fontbutton));
    gtk_color_button_get_color (configure_widget.widget_lrc_colorbutton_1, &color);
    strcpy(configure.widget_lrc_front_color,gtk_color_selection_palette_to_string(&color,1));
    gtk_color_button_get_color (configure_widget.widget_lrc_colorbutton_2, &color);
    strcpy(configure.widget_lrc_back_color,gtk_color_selection_palette_to_string(&color,1));

    strcpy(configure.desktop_lrc_font,gtk_font_button_get_font_name(configure_widget.desktop_lrc_fontbutton));

    gtk_color_button_get_color (configure_widget.desktop_lrc_colorbutton_1, &color);
    strcpy(configure.desktop_lrc_front_up_color,gtk_color_selection_palette_to_string(&color,1));
    gtk_color_button_get_color (configure_widget.desktop_lrc_colorbutton_2, &color);
    strcpy(configure.desktop_lrc_front_cen_color,gtk_color_selection_palette_to_string(&color,1));
    gtk_color_button_get_color (configure_widget.desktop_lrc_colorbutton_3, &color);
    strcpy(configure.desktop_lrc_front_down_color,gtk_color_selection_palette_to_string(&color,1));
    gtk_color_button_get_color (configure_widget.desktop_lrc_colorbutton_4, &color);
    strcpy(configure.desktop_lrc_back_up_color,gtk_color_selection_palette_to_string(&color,1));
    gtk_color_button_get_color (configure_widget.desktop_lrc_colorbutton_5, &color);
    strcpy(configure.desktop_lrc_back_cen_color,gtk_color_selection_palette_to_string(&color,1));
    gtk_color_button_get_color (configure_widget.desktop_lrc_colorbutton_6, &color);
    strcpy(configure.desktop_lrc_back_down_color,gtk_color_selection_palette_to_string(&color,1));
    gtk_color_button_get_color (configure_widget.desktop_lrc_word_stroke_colorbutton, &color);
    strcpy(configure.desktop_lrc_word_stroke_color,gtk_color_selection_palette_to_string(&color,1));
    configure.desktop_lrc_word_stroke = atoi(gtk_entry_get_text(configure_widget.desktop_lrc_word_stroke_entry));

    strcpy(configure.lists_font,gtk_font_button_get_font_name(configure_widget.lists_fontbutton));
    gtk_color_button_get_color (configure_widget.lists_back_color_button, &color);
    strcpy(configure.lists_back_color,gtk_color_selection_palette_to_string(&color,1));
    gtk_color_button_get_color (configure_widget.lists_front_color_button, &color);
    strcpy(configure.lists_front_color,gtk_color_selection_palette_to_string(&color,1));


    strcpy( configure.download_path,gtk_entry_get_text(configure_widget.music_download_path_entry ));

    strcpy( configure.quick_show_and_hide,gtk_entry_get_text(configure_widget.quick_shortcut_entry_1 ));
    strcpy( configure.quick_play_and_pause ,gtk_entry_get_text(configure_widget.quick_shortcut_entry_2 ));
    strcpy( configure.quick_previous ,gtk_entry_get_text(configure_widget.quick_shortcut_entry_3 ));
    strcpy( configure.quick_next ,gtk_entry_get_text(configure_widget.quick_shortcut_entry_4 ));
    strcpy( configure.quick_stop ,gtk_entry_get_text(configure_widget.quick_shortcut_entry_5 ));
    strcpy( configure.quick_quit ,gtk_entry_get_text(configure_widget.quick_shortcut_entry_6 ));
    strcpy( configure.quick_research_lrc ,gtk_entry_get_text(configure_widget.quick_shortcut_entry_7 ));
    strcpy( configure.widget_lrc_Independent_back_image ,gtk_entry_get_text(configure_widget.widget_back_pic_entry ));
    strcpy( configure.back_image ,gtk_entry_get_text(configure_widget.back_pic_entry ));
...
//type 1=read 0=wirte
    ...
    if (type == 1) {
        ...
        filechooserdialog = gtk_file_chooser_dialog_new("", NULL,GTK_FILE_CHOOSER_ACTION_SAVE, NULL,NULL);
    ...
    GdkPixbuf *IcePlayer_icon_pixbuf=gdk_pixbuf_new_from_file("/usr/share/iceplayer/iceplayer.png", NULL);
    ...
    gtk_file_filter_set_name(filter, _("配置文件"));
    ...
    if (aw==-5) {
        ...
        strcpy(path,gtk_file_chooser_get_filename((GtkFileChooser *) filechooserdialog));
...
void wirte_desktop_lrc_config() {
    ...
    if (file) {
        fclose(file);
        GtkWidget *dialog = gtk_message_dialog_new(NULL,GTK_DIALOG_DESTROY_WITH_PARENT    ,GTK_MESSAGE_QUESTION,GTK_BUTTONS_OK_CANCEL,_("已存在目标文件，是否覆盖?"));
...
///
        ...
        CONFIG_READ_FAILED_str(configure.desktop_lrc_front_cen_color , "#F5A91E")
...
void edit_search_lrc_key() {
 ...
 if(editor!=NULL){
    ...
    g_free_n(command);
        ...
        GtkWidget *dialog_real = gtk_message_dialog_new_with_markup(NULL,GTK_DIALOG_DESTROY_WITH_PARENT    ,GTK_MESSAGE_QUESTION,   GTK_BUTTONS_OK,"抱歉，没有找到你计算机上面的记事本程序，包括gedit kedit leafpad mousepad都无法找到，请手动编辑 ~/.iceplayer/black_list.conf");
...
void configure_to_configure_widget() {
    ...
    gtk_toggle_button_set_active(configure_widget.auto_update_checkbutton,configure.auto_update   );
    gtk_toggle_button_set_active(configure_widget.show_in_taskbar_checkbutton,configure.task_bar   );
    gtk_toggle_button_set_active(configure_widget.decorated,configure.decorated);
    gtk_toggle_button_set_active(configure_widget.show_tray_checkbutton,configure.tray    );
    gtk_toggle_button_set_active(configure_widget.always_above_checkbutton,configure.above   );
    gtk_toggle_button_set_active(configure_widget.show_in_all_work_places_checkbutton,configure.all_work_places   );
    gtk_toggle_button_set_active(configure_widget.open_and_min_checkbutton,configure.begin_min   );
    gtk_toggle_button_set_active(configure_widget.last_pos_checkbutton,configure.last_pos  );
    gtk_toggle_button_set_active(configure_widget.open_and_play_checkbutton,configure.begin_play   );
    gtk_toggle_button_set_active(configure_widget.notify_checkbutton,configure.notify   );
    gtk_toggle_button_set_active(configure_widget.failed_and_stop_checkbutton,configure.failed_stop   );
    gtk_toggle_button_set_active(configure_widget.auto_jump_to_playing_checkbutton,configure.auto_jump_to_play   );
    gtk_toggle_button_set_active(configure_widget.use_lrc_checkbutton,configure.lrc   );
    gtk_toggle_button_set_active(configure_widget.use_search_lrc_checkbutton,configure.search_lrc   );
    gtk_toggle_button_set_active(configure_widget.search_lrc_with_filename_and_id3_checkbutton,configure.search_filename_or_id3   );
    gtk_toggle_button_set_active(configure_widget.use_desktop_lrc_checkbutton,configure.desktop_lrc   );
    gtk_toggle_button_set_active(configure_widget.edit_search_lrc_checkbutton,configure.edit_search_word   );
    gtk_toggle_button_set_active(configure_widget.desktop_lrc_lock_checkbutton,configure.desktop_lrc_lock  );
    gtk_toggle_button_set_active(configure_widget.desktop_lrc_use_kalaok_checkbutton,configure.desktop_lrc_kalaok   );
    gtk_toggle_button_set_active(configure_widget.desktop_lrc_above_checkbutton,configure.desktop_lrc_above   );
    gtk_toggle_button_set_active(configure_widget.lists_use_system_theme_checkbutton,configure.lists_use_system_theme   );

    gtk_entry_set_text((configure_widget.search_lrc_time_entry ),configure.search_lrc_time);
    gtk_entry_set_text((configure_widget.lrc_download_path_entry ),configure.download_lrc_path);
    gtk_entry_set_text((configure_widget.local_lrc_path_1_entry ),configure.search_lrc_path_1);
    gtk_entry_set_text((configure_widget.local_lrc_path_2_entry ),configure.search_lrc_path_2);
    gtk_entry_set_text((configure_widget.local_lrc_path_3_entry ),configure.search_lrc_path_3);

    gtk_font_button_set_font_name(configure_widget.info_name_fontbutton,configure.info_name_font);
    gtk_font_button_set_font_name(configure_widget.info_time_fontbutton,configure.info_time_font);

    GdkColor *color;
    gtk_font_button_set_font_name(configure_widget.lists_fontbutton,configure.lists_font);
    gtk_color_selection_palette_from_string(configure.lists_front_color,&color,NULL);
    gtk_color_button_set_color (configure_widget.lists_front_color_button, color);
    gtk_color_selection_palette_from_string(configure.lists_back_color,&color,NULL);
    gtk_color_button_set_color (configure_widget.lists_back_color_button, color);

    gtk_font_button_set_font_name(configure_widget.widget_lrc_fontbutton,configure.widget_lrc_font);
    gtk_color_selection_palette_from_string(configure.widget_lrc_front_color,&color,NULL);
    gtk_color_button_set_color (configure_widget.widget_lrc_colorbutton_1, color);
    gtk_color_selection_palette_from_string(configure.widget_lrc_back_color,&color,NULL);
    gtk_color_button_set_color (configure_widget.widget_lrc_colorbutton_2, color);
    gtk_entry_set_text(configure_widget.widget_back_pic_entry,configure.widget_lrc_Independent_back_image );
    gtk_entry_set_text(configure_widget.back_pic_entry,configure.back_image);
    gchar a[50];
    sprintf(a,"%d",configure.desktop_lrc_word_stroke);
    gtk_entry_set_text(configure_widget.desktop_lrc_word_stroke_entry,a);

    gtk_font_button_set_font_name(configure_widget.desktop_lrc_fontbutton,configure.desktop_lrc_font);
    gtk_color_selection_palette_from_string(configure.desktop_lrc_front_up_color,&color,NULL);
    gtk_color_button_set_color (configure_widget.desktop_lrc_colorbutton_1, color);
    gtk_color_selection_palette_from_string(configure.desktop_lrc_front_cen_color,&color,NULL);
    gtk_color_button_set_color (configure_widget.desktop_lrc_colorbutton_2, color);
    gtk_color_selection_palette_from_string(configure.desktop_lrc_front_down_color,&color,NULL);
    gtk_color_button_set_color (configure_widget.desktop_lrc_colorbutton_3, color);
    gtk_color_selection_palette_from_string(configure.desktop_lrc_back_up_color,&color,NULL);
    gtk_color_button_set_color (configure_widget.desktop_lrc_colorbutton_4, color);
    gtk_color_selection_palette_from_string(configure.desktop_lrc_back_cen_color,&color,NULL);
    gtk_color_button_set_color (configure_widget.desktop_lrc_colorbutton_5, color);
    gtk_color_selection_palette_from_string(configure.desktop_lrc_back_down_color,&color,NULL);
    gtk_color_button_set_color (configure_widget.desktop_lrc_colorbutton_6, color);
    gtk_color_selection_palette_from_string(configure.desktop_lrc_word_stroke_color,&color,NULL);
    gtk_color_button_set_color (configure_widget.desktop_lrc_word_stroke_colorbutton, color);

    gtk_entry_set_text(configure_widget.music_download_path_entry ,configure.download_path);

    gtk_entry_set_text(configure_widget.quick_shortcut_entry_1,configure.quick_show_and_hide );
    gtk_entry_set_text(configure_widget.quick_shortcut_entry_2,configure.quick_play_and_pause );
    gtk_entry_set_text(configure_widget.quick_shortcut_entry_3,configure.quick_previous );
    gtk_entry_set_text(configure_widget.quick_shortcut_entry_4,configure.quick_next );
    gtk_entry_set_text(configure_widget.quick_shortcut_entry_5,configure.quick_stop );
    gtk_entry_set_text(configure_widget.quick_shortcut_entry_7,configure.quick_research_lrc );
    gtk_entry_set_text(configure_widget.quick_shortcut_entry_6,configure.quick_quit );

    gchar info_text[256];
    sprintf(info_text,"%d",configure.info_name_x);
    gtk_entry_set_text(configure_widget.info_name_entry_x,info_text);
    sprintf(info_text,"%d",configure.info_name_y);
    gtk_entry_set_text(configure_widget.info_name_entry_y,info_text);
    sprintf(info_text,"%d",configure.info_time_x);
    gtk_entry_set_text(configure_widget.info_time_entry_x,info_text);
    sprintf(info_text,"%d",configure.info_time_y);
    gtk_entry_set_text(configure_widget.info_time_entry_y,info_text);
}
gboolean configure_to_iceplayer_widget() {
    print_programming(("configure_to_iceplayer_widget\n"));
    gtk_window_resize(iceplayer.window,configure.width,configure.height);
    gtk_window_move(iceplayer.window,configure.x,configure.y);
    if (configure.widget_lrc_show_type == WIDGET_LRC_SHOW_TYPE_HPANED&&configure.show_page==SWITCH_LRC)
        configure.show_page=SWITCH_LIST;
    if (configure.widget_lrc_show_type == WIDGET_LRC_SHOW_TYPE_INDEPENDENT&&configure.show_page==SWITCH_LRC)
        configure.show_page=SWITCH_LIST;
    //gtk_notebook_set_current_page(iceplayer.notebook,configure.show_page);
    gtk_paned_set_position(iceplayer.hpaned,configure.hpaned_pos );
    gtk_paned_set_position(iceplayer.list_hpaned,configure.list_hpaned_pos );
    ...
    gtk_range_set_value(configure_widget.window_alpha_hscale,configure.window_alpha);

    g_timeout_add(5,change_alpha,configure_widget.window_alpha_hscale);
...
//17000
    ...
    if (GTK_IS_WIDGET(desktop_lrc.window)) {
        if (configure.desktop_lrc&&configure.lrc) {
            ...
            gtk_window_move(desktop_lrc.window,configure.desktop_lrc_x,configure.desktop_lrc_y);
            gtk_window_resize(desktop_lrc.window,configure.desktop_lrc_width,configure.desktop_lrc_height);
        } else {
            gtk_label_set_text(iceplayer.widget_lrc_label,"");
            gtk_label_set_text(widget_lrc.label,"");
    ...
    gtk_window_get_position(widget_lrc.window,&x,&y);
    gtk_window_get_size(widget_lrc.window,&w,&h);
    ...
    if ((x!=0)&&(y!=0)&&(w!=170)&&(h!=250)&&!configure.lrc&&configure.widget_lrc_show_type==WIDGET_LRC_SHOW_TYPE_INDEPENDENT) {
        ...
        if (configure.widget_lrc_show_type == WIDGET_LRC_SHOW_TYPE_INDEPENDENT) {
            ...
            gtk_window_move(widget_lrc.window,configure.widget_lrc_Independent_x,configure.widget_lrc_Independent_y);
            gtk_window_resize(widget_lrc.window,configure.widget_lrc_Independent_width,configure.widget_lrc_Independent_height);
            ...
            if (configure.widget_lrc_show_type != WIDGET_LRC_SHOW_TYPE_HPANED) {
                if (GTK_IS_WIDGET(iceplayer.widget_lrc_label_hpaned))gtk_container_remove_new(GTK_CONTAINER(iceplayer.hpaned),iceplayer.widget_lrc_label_hpaned);
            }
            gtk_widget_hide(widget_lrc.window);
        }
    }
    ...
    sscanf(gtk_entry_get_text(configure_widget.info_name_entry_x),"%d",&configure.info_name_x);
    sscanf(gtk_entry_get_text(configure_widget.info_name_entry_y),"%d",&configure.info_name_y);

    sscanf(gtk_entry_get_text(configure_widget.info_time_entry_x),"%d",&configure.info_time_x);
    sscanf(gtk_entry_get_text(configure_widget.info_time_entry_y),"%d",&configure.info_time_y);

    if (!(configure.info_name_x==0&&configure.info_name_y==0)) {
        gtk_fixed_move_new(GTK_FIXED (iceplayer.main_fixed),iceplayer.name_label,configure.info_name_x,configure.info_name_y);
    } else {
        gtk_fixed_move_new(GTK_FIXED (iceplayer.main_fixed),iceplayer.name_label,skin.info_name_x,skin.info_name_y);
    }
    if (!(configure.info_time_x==0&&configure.info_time_y==0)) {
        gtk_fixed_move_new(GTK_FIXED (iceplayer.main_fixed),iceplayer.time_label,configure.info_time_x,configure.info_time_y);
    } else {
        gtk_fixed_move_new(GTK_FIXED (iceplayer.main_fixed),iceplayer.time_label,skin.info_time_x,skin.info_time_y);
    }
...
void configure_sw_page(gpointer * one,gint type) {
    ...
    gtk_notebook_set_current_page(configure_widget.notebook,type);
}
void configure_ui_init() {
    ...
    gtk_box_pack_start  (GTK_CONTAINER (configure_widget.sw_vbox), configure_widget.sw_hbox, FALSE, TRUE, 0);

    configure_widget.sw_normal_button = gtk_button_new_with_label(_("常规"));
    gtk_widget_show(configure_widget.sw_normal_button);
    gtk_box_pack_start (GTK_CONTAINER (configure_widget.sw_hbox), configure_widget.sw_normal_button, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start  (GTK_CONTAINER (configure_widget.sw_hbox), configure_widget.sw_play_button, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start  (GTK_CONTAINER (configure_widget.sw_hbox), configure_widget.sw_skin_button, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start  (GTK_CONTAINER (configure_widget.sw_hbox), configure_widget.sw_lrc_button, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start  (GTK_CONTAINER (configure_widget.sw_hbox), configure_widget.sw_quick_button, TRUE, TRUE, 0);
    ...
    */
    ...
    gtk_container_add (GTK_CONTAINER (configure_widget.notebook), configure_widget.lrc_scrolledwindow);
    ...
    gtk_scrolled_window_add_with_viewport(configure_widget.lrc_scrolledwindow,configure_widget.lrc_notebook);
    gtk_notebook_set_tab_pos( configure_widget.lrc_notebook ,GTK_POS_LEFT);

    configure_widget.table4 = gtk_table_new (14, 3, FALSE);
    gtk_widget_show (configure_widget.table4);
    gtk_container_add (GTK_CONTAINER (configure_widget.lrc_notebook), configure_widget.table4);
    ...
    gtk_button_set_label(configure_widget.search_lrc_key_word_help_button,"->黑名单功能说明与帮助");
    ...
    gtk_button_set_label(configure_widget.search_lrc_key_word_button,"设定搜索歌词黑名单");
...
// gtk_widget_set_size_request(configure_widget.label31,0,-1);
    ...
    gtk_label_set_selectable(configure_widget.desktop_lrc_label,TRUE);
...
void change_skin(GtkWidget *wi,gchar *n) {
    ...
    inline void remove(GtkWidget *widget) {
        gtk_container_remove_new(widget->parent,widget);
    }
    ...
    add (GTK_CONTAINER (iceplayer.menu_eventbox), iceplayer.menu_image);
    add (GTK_CONTAINER (iceplayer.mini_eventbox), iceplayer.mini_image);
    add (GTK_CONTAINER (iceplayer.above_eventbox), iceplayer.above_image);
    add (GTK_CONTAINER (iceplayer.min_eventbox), iceplayer.min_image);
    add (GTK_CONTAINER (iceplayer.max_eventbox), iceplayer.max_image);
    add (GTK_CONTAINER (iceplayer.close_eventbox), iceplayer.close_image);
    add (GTK_CONTAINER (iceplayer.prev_eventbox), iceplayer.prev_image);
    add (GTK_CONTAINER (iceplayer.play_eventbox), iceplayer.play_image);
    add (GTK_CONTAINER (iceplayer.next_eventbox), iceplayer.next_image);
    add (GTK_CONTAINER (iceplayer.stop_eventbox), iceplayer.stop_image);

    add (GTK_CONTAINER (iceplayer.mini_mini_eventbox), iceplayer.mini_mini_image);
    add (GTK_CONTAINER (iceplayer.mini_close_eventbox), iceplayer.mini_close_image);
    add (GTK_CONTAINER (iceplayer.mini_prev_eventbox), iceplayer.mini_prev_image);
    add (GTK_CONTAINER (iceplayer.mini_play_eventbox), iceplayer.mini_play_image);
    add (GTK_CONTAINER (iceplayer.mini_next_eventbox), iceplayer.mini_next_image);
    add (GTK_CONTAINER (iceplayer.mini_lists_eventbox), iceplayer.mini_lists_image);
    add (GTK_CONTAINER (iceplayer.mini_songs_eventbox), iceplayer.mini_songs_image);
    add (GTK_CONTAINER (iceplayer.mini_stop_eventbox), iceplayer.mini_stop_image);

    add (GTK_CONTAINER (iceplayer.open_eventbox), iceplayer.open_image);
    add (GTK_CONTAINER (iceplayer.progress_left_eventbox), iceplayer.progress_left_image);
    add (GTK_CONTAINER (iceplayer.progress_node_eventbox), iceplayer.progress_node_image);
    add (GTK_CONTAINER (iceplayer.progress_right_eventbox), iceplayer.progress_right_image);
    add (GTK_CONTAINER (iceplayer.volume_eventbox), iceplayer.volume_image);
    add (GTK_CONTAINER (iceplayer.switch_list_eventbox), iceplayer.switch_list_image);
    add (GTK_CONTAINER (iceplayer.switch_lrc_eventbox), iceplayer.switch_lrc_image);
    add (GTK_CONTAINER (iceplayer.switch_music_box_eventbox), iceplayer.switch_music_box_image);
    add (GTK_CONTAINER (iceplayer.switch_configure_eventbox), iceplayer.switch_configure_image);
    add (GTK_CONTAINER (iceplayer.switch_help_eventbox), iceplayer.switch_help_image);
    add (GTK_CONTAINER (iceplayer.resize_buttom_left_eventbox), iceplayer.resize_buttom_left_image);
    add (GTK_CONTAINER (iceplayer.resize_buttom_right_eventbox), iceplayer.resize_buttom_right_image);
    //add (GTK_CONTAINER (iceplayer.resize_left_eventbox), iceplayer.resize_left_image);
    add (GTK_CONTAINER (iceplayer.resize_top_left_eventbox), iceplayer.resize_top_left_image);
    //add (GTK_CONTAINER (iceplayer.resize_top_eventbox), iceplayer.resize_top_image);
    add (GTK_CONTAINER (iceplayer.resize_top_right_eventbox), iceplayer.resize_top_right_image);
   // add (GTK_CONTAINER (iceplayer.resize_buttom_eventbox), iceplayer.resize_buttom_image);
    //add (GTK_CONTAINER (iceplayer.resize_right_eventbox), iceplayer.resize_right_image);

    add (GTK_CONTAINER (widget_lrc.above_eventbox),widget_lrc.above_image);
    add (GTK_CONTAINER (widget_lrc.min_eventbox),widget_lrc.min_image);
    add (GTK_CONTAINER (widget_lrc.max_eventbox),widget_lrc.max_image);
    add (GTK_CONTAINER (widget_lrc.close_eventbox),widget_lrc.close_image);

    //add (GTK_CONTAINER (widget_lrc.left_eventbox),widget_lrc.left_image);
    //add (GTK_CONTAINER (widget_lrc.right_eventbox),widget_lrc.right_image);
    //add (GTK_CONTAINER (widget_lrc.top_eventbox),widget_lrc.top_image);
    //add (GTK_CONTAINER (widget_lrc.buttom_eventbox),widget_lrc.buttom_image);
    add (GTK_CONTAINER (widget_lrc.top_left_eventbox),widget_lrc.top_left_image);
    add (GTK_CONTAINER (widget_lrc.top_right_eventbox),widget_lrc.top_right_image);
    add (GTK_CONTAINER (widget_lrc.buttom_left_eventbox),widget_lrc.buttom_left_image);
    add (GTK_CONTAINER (widget_lrc.buttom_right_eventbox),widget_lrc.buttom_right_image);
    ...
    gtk_fixed_move_new (GTK_FIXED (iceplayer.mini_fixed), iceplayer.mini_close_eventbox,  skin.mini_close_x, skin.mini_close_y);
    gtk_fixed_move_new (GTK_FIXED (iceplayer.mini_fixed), iceplayer.mini_mini_eventbox,  skin.mini_mini_x, skin.mini_mini_y);
    gtk_fixed_move_new (GTK_FIXED (iceplayer.mini_fixed), iceplayer.mini_prev_eventbox, skin.mini_prev_x, skin.mini_prev_y);
    gtk_fixed_move_new (GTK_FIXED (iceplayer.mini_fixed), iceplayer.mini_play_eventbox, skin.mini_play_x,skin.mini_play_y);
    gtk_fixed_move_new (GTK_FIXED (iceplayer.mini_fixed), iceplayer.mini_next_eventbox, skin.mini_next_x, skin.mini_next_y);
    gtk_fixed_move_new (GTK_FIXED (iceplayer.mini_fixed), iceplayer.mini_stop_eventbox, skin.mini_stop_x, skin.mini_stop_y);
    gtk_fixed_move_new (GTK_FIXED (iceplayer.mini_fixed), iceplayer.mini_songs_eventbox,  skin.mini_songs_x, skin.mini_songs_y);
    gtk_fixed_move_new (GTK_FIXED (iceplayer.mini_fixed), iceplayer.mini_lists_eventbox,  skin.mini_lists_x, skin.mini_lists_y);
...
void skin_menu() {
    ...
    strcpy(path,"/usr/share/iceplayer/skin/");
    ...
    while (ptr) {
        if (ptr->d_name[0]!='.') {
            ...
            if (dir2) {
                closedir(dir2);
                strcpy(skin_dir," /usr/share/iceplayer | ");
                GtkWidget *menu_item = gtk_image_menu_item_new_with_label(strcat(skin_dir,ptr->d_name));
                gtk_menu_shell_append(GTK_MENU_SHELL(menu),menu_item);
                g_signal_connect(menu_item ,"activate",G_CALLBACK(change_skin),(gpointer)ptr->d_name);
            }
