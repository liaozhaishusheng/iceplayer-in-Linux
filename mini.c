...
void init_mini() {
    ...
    gtk_fixed_put(iceplayer.mini_fixed,iceplayer.mini_close_eventbox,skin.mini_close_x,skin.mini_close_y);
    ...
    gtk_fixed_put(iceplayer.mini_fixed,iceplayer.mini_lists_eventbox,skin.mini_lists_x,skin.mini_lists_y);
    ...
    gtk_fixed_put(iceplayer.mini_fixed,iceplayer.mini_mini_eventbox,skin.mini_mini_x,skin.mini_mini_y);
    ...
    gtk_fixed_put(iceplayer.mini_fixed,iceplayer.mini_next_eventbox,skin.mini_next_x,skin.mini_next_y);
    ...
    gtk_fixed_put(iceplayer.mini_fixed,iceplayer.mini_play_eventbox,skin.mini_play_x,skin.mini_play_y);
    ...
    gtk_fixed_put(iceplayer.mini_fixed,iceplayer.mini_prev_eventbox,skin.mini_prev_x,skin.mini_prev_y);
    ...
    gtk_fixed_put(iceplayer.mini_fixed,iceplayer.mini_stop_eventbox,skin.mini_stop_x,skin.mini_stop_y);
    ...
    gtk_fixed_put(iceplayer.mini_fixed,iceplayer.mini_songs_eventbox,skin.mini_songs_x,skin.mini_songs_y);
